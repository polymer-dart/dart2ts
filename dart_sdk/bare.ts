...
export namespace dart2ts {
    export namespace symbols {
        export const equals: symbol = Symbol('equals');
        export const hashCode: symbol = Symbol('hashCode');
        export const privs: symbol = Symbol('private');
        export const getPrivate: symbol = Symbol('getPrivate');
        export const setPrivate: symbol = Symbol('setPrivate');
    }
}
...
declare global {
    ...
    interface Object {
        ...
        readonly [Symbol.dart2ts]: ObjectExtensions;
...
var lastObjectId: number = 0;

export class ObjectExtensions extends Object {
    ...
    [dart2ts.symbols.getPrivate](name: string): any {
        this[dart2ts.symbols.privs] = this[dart2ts.symbols.privs] || Object.create(null);
        return this[dart2ts.symbols.privs][name];
    }

    [dart2ts.symbols.setPrivate](name: string, v: any): void {
        this[dart2ts.symbols.privs] = this[dart2ts.symbols.privs] || Object.create(null);
        this[dart2ts.symbols.privs][name] = v;
    }

    [dart2ts.symbols.equals](o: any): boolean {
        return o === this;
    }

    [dart2ts.symbols.hashCode](): number {
        let code: number = this[dart2ts.symbols.getPrivate]('hashCode');
        if (code === undefined) {
            code = lastObjectId++;
            this[dart2ts.symbols.setPrivate]('hashCode', code);
        }
        return code;
    }
}

extendPrototype(Object, ObjectExtensions);
